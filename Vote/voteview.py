...
if __name__ == "__main__":
    ...
    el_voteview = EL_Voteview(usr=usr, title=title, data=data, votelimit=votelimit, captcha=captcha)
    el_voteview.show()
    pa_voteview = PA_Voteview(usr=usr, title=title, data=data, votelimit=votelimit, captcha=captcha)
    pa_voteview.show()
    sys.exit(app.exec_())
