...
# from HE.MHE import keyGen_Elg, save_key, load_key
from APP.util import center
from HE.ElGamal import keyGen_Elg, save_key, load_key

class EL_KeyGenWindow(QWidget):
    ...
    def initUI(self):
        ...
        title_EL=QLabel(self)
        title_EL.setText('ELGamal')
    ...
    def onConfirm(self):
        ...
        if keysize == 0:
            ...
            (pubkey, privkey) = keyGen_Elg(keysize)
